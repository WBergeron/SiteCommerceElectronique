...
--
-- Hôte : 127.0.0.1:3307
-- Généré le : mar. 21 fév. 2023 à 14:52
...
CREATE TABLE IF NOT EXISTS `produits` (
  ...
  KEY `IDX_D34A04AD497DD634` (`categorie`)
...
(6, 'Kailh Super Speed Switch Bronze', 72.99, 50, 'Lot de 110 switches Super Speed Bronze, 3 pins de Kailh. Ils conviendront a des gens qui demande des switches performante pour écrire rapidement. Les Kailh super speed bronze sont des switches à \"bumb\" a 1.4mm de distance d\'activation pour un total de 3.5mm de distance. Pour être enclenché, elle a besoin de 48 cN de force.', 'img/switchs/kailh-super-speed-bronze-set_.jpg', 1),
...
(8, 'Keychron Q1 QMK Custom Mechanical Keyboard V2', 159.99, 40, 'Clavier mécanique en \"hot-swap\", full aluminium Q1 de Keychron. Le clavier est muni du \"Double-Gasket\", une technologie d\'amortissement du clavier suite au click d\'une switch. Format 75%, couleur noir.', 'img/keyboards/Q1-QMK-V2-Black.jpg', 2),
...
--
ALTER TABLE `produit`
  ADD CONSTRAINT `FK_D34A04AD497DD634` FOREIGN KEY (`categorie`) REFERENCES `categorie` (`idCategorie`);
COMMIT;
